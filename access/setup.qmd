...
|-----------| ----------- | ----------- | ----------- |
| **IGV - Integrative Genomics viewer**  | A High-performance, easy-to-use, interactive tool for the visual exploration of genomic data. It supports flexible integration of all the common types of genomic data and metadata, investigator-generated or publicly available | [Official Manual](https://igvteam.github.io/igv-webapp/) | Interactive User Interface |
...
| **Introduction to GWAS**  | [Zenodo Link](https://github.com/hds-sandbox/GWAS_course) | [GitHub repo](https://github.com/hds-sandbox/GWAS_course)|
