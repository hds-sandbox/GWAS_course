...
::: {.hero-buttons}
[Data](./hapmap.zip){.btn-action-smk .btn-action .btn .btn-success .btn-lg role="button"}
[Notebook](https://raw.githubusercontent.com/hds-sandbox/GWAS_course/refs/heads/main/Webpage/develop/GWAS4_extra_population_structure.ipynb){.btn-action-smk .btn-action .btn .btn-success .btn-lg role="button"}
