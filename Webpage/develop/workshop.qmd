...
You can download an extra notebook and data: 

::: {.hero-buttons}
[Hapmap extra](./hapmap.zip){.btn-action-smk .btn-action .btn .btn-success .btn-lg role="button"}
[GWAS4 extra nb](./GWAS4_extra_population_structure.ipynb){.btn-action-smk .btn-action .btn .btn-success .btn-lg role="button"}
